      ...
      <div className="w-full max-h-full overflow-y-auto">
        <table className="w-full table-fixed border-collapse text-center border-l-[1px] border-r-[1px] border-b-[1px]"> {/* Added table-fixed */}
          <thead className="bg-[#EFEFEF] w-full sticky top-0">
            <tr className='h-[50px] border-b-[1px]'>
              <th className='h-[50px] w-[10%] py-3 text-[16px]'>ID</th>
          ...
          <tbody className='z-0'>
            {Array.from({ length: 30 }).map((_, index) => (
              <tr key={index} className='text-[#797979] border-b-[1px]'>
                ...
                <td className="flex items-center justify-center truncate overflow-hidden whitespace-nowrap m-0 py-5"><RiDeleteBin6Fill className='text-[#E03131] text-[24px] cursor-pointer'/></td>
              </tr>
            ))}
          </tbody>
        </table>
